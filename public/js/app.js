...
var current_case_id = 0;
$(function () {
  $("#form_store_case_follow").on('submit', function (e) {
    e.preventDefault();
    var body = $("#txt_body_case_follow").val();
      ...
      $.ajax({
        ...
        success: function success(data) {
          ...
          $.each(data, function (index, value) {
            counter++;
            $("#CaseFollowBox").append('<div class="comment-item">' + '<label class="color-primary-sys font-weight-bold">' + value.author + "</label>" + "<br/>" + value.body + "<br/>" + '<span class="font-weight-bold float-right">' + value.created_at + "</span>" + "<br/>" + "</div><br/>");
          });
          setTimeout(function () {
            $("#CaseFollowBox").animate({
...
window.createUser = function () {
  return $("#modal_create_user").modal();
};
...
window.createCase = function () {
  return $("#modal_create_case").modal();
};

window.createArea = function () {
  return $("#modal_create_area").modal();
};

window.createType = function () {
  return $("#modal_create_type").modal();
};
...
window.createSuggestion = function () {
  return $("#modal_create_suggestion").modal();
};

window.createCaseBinnacle = function () {
  return $("#modal_create_case_binnacle").modal();
};
...
window.destroyBinnacle = function (id) {
  alertify.confirm("", function () {
...
window.updateFollowBox = function (id) {
...
window.caseFollow = function (id) {
  ...
  $.ajax({
    ...
    success: function success(data) {
      ...
      if (counter <= 0) {
        $("#CaseFollowBox").html('<center><span style="background-color:#F7DC6F;padding:5px;border-radius:3px;" class="text-center font-weight-bold">' + "Aún no se han agregado seguimientos" + "</span></center>");
      }
    },
    error: function error(err) {
      return console.log(err);
...
window.recargarSeguimientos = function (pusher_id) {
...
window.takeCase = function (case_id) {
  alertify.confirm("", function () {
    Livewire.emit('takeCase', case_id);
  }, function () {//alertify.error('Cancel');
  }).set('labels', {
    ok: 'Si, quiero tomar el caso!',
    cancel: 'Cancelar'
  }).set({
    transition: 'flipx',
    title: 'Alerta',
    message: '¿Tomar este caso?'
  });
};
...
Livewire.on('showCaseBinnacles', function () {
  return $("#modal_show_case_binnacles").modal();
});
Livewire.on('createBinnacleImageModal', function () {
  return $("#modal_create_binnacle_image").modal();
});
Livewire.on('editUser', function () {
  return $("#modal_edit_user").modal();
});
...
Livewire.on('editArea', function () {
  return $("#modal_edit_area").modal();
});
Livewire.on('editType', function () {
  return $("#modal_edit_type").modal();
});
...
Livewire.on('editSuggestion', function () {
  return $("#modal_edit_suggestion").modal();
});
Livewire.on('editCaseBinnacle', function () {
  return $("#modal_edit_case_binnacle").modal();
});
...
Livewire.on('dismissCreateCaseModal', function () {
  return $("#modal_create_case").modal('hide');
});
Livewire.on('dismissCreateAreaModal', function () {
  return $("#modal_create_area").modal('hide');
});
Livewire.on('dismissCreateTypeModal', function () {
  return $("#modal_create_type").modal('hide');
});
...
Livewire.on('dismissCreateSuggestionModal', function () {
  return $("#modal_create_suggestion").modal('hide');
});
...
Livewire.on('dismissEditAreaModal', function () {
  return $("#modal_edit_area").modal('hide');
});
Livewire.on('dismissEditTypeModal', function () {
  return $("#modal_edit_type").modal('hide');
});
...
Livewire.on('dissmisCreateCaseBinnacle', function () {
  return $("#modal_create_case_binnacle").modal('hide');
});
Livewire.on('dissmisEditCaseBinnacle', function () {
  return $("#modal_edit_case_binnacle").modal('hide');
});
Livewire.on('dissmisCreateBinnacleImage', function () {
  return $("#modal_create_binnacle_image").modal('hide');
});
...
window.viewBinnacleImages = function (binnacle_id, count) {
  if (count > 0) {
    var newwindow = window.open('binnacle_images_index/' + binnacle_id, "Imagenes", 'height=800,width=800');
